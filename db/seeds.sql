...
('Mercury', 57000000000, "tbd description", "/assets/images/planets/mercury.png", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Moon', 0, "Moon tbd",  "/assets/images/planets/moon.png", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('Pluto', 0, "123tbd", "imagelinktbd", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES
(CURRENT_TIMESTAMP, 1600000000000, 'SAT543', "2020-12-16 11:37:30.0", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 3 ,8, 1, 9),
(CURRENT_TIMESTAMP, 1340000000000, 'VEN191', "2020-08-31 23:55:19.0", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 2, 3, 1, 2),
(CURRENT_TIMESTAMP, 80000000, 'MAR943', "2021-04-3 15:17:02.0", CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 6, 1, 11);
